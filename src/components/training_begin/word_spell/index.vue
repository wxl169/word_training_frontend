    ...
    <div style="margin-top: 10px">
        <a-layout style="background-color: transparent">
            ...
            <a-layout-content id="contentStyle">
                ...
                <div id="questionArea">
                    <!-- 中文 -->
                    <h1 style="text-align: center; font-size: 36px">int_r</h1>
                    <p style="text-align: center;margin-top: 30px;font-size: 16px;">
                        n:单词;字;信息;话语;言语;说的话;保证;《圣经》;诺言;许诺
                        <br>
                        vt:措辞;用词
                        <br>
                        int:表示接受或同意别人刚说的话就是，说得对
                    </p>
                </div>
                <!-- 答题区 -->
                <div id="answerArea">
                    <a-radio-group v-model:value="value1" optionType="button" @change="onChange">
                        <div class="radioRow">
                            <a-radio value="a" class="radioStyle" style="margin-top: 330px;">in</a-radio>
                            <a-radio value="b" class="radioStyle" style="margin:330px 0px 0px 40px">gh</a-radio>
                            <a-radio value="c" class="radioStyle" style="margin:330px 0px 0px 40px">th</a-radio>
                        </div>
                        <div class="radioRow">
                            <a-radio value="d" class="radioStyle" style="margin-top: 20px;">tr</a-radio>
                            <a-radio value="e" class="radioStyle" style="margin:20px 0px 0px 40px;">sh</a-radio>
                            <a-radio value="f" class="radioStyle" style="margin:20px 0px 0px 40px">e</a-radio>
                        </div>
                        <div class="radioRow">
                            <a-radio value="g" class="radioStyle" style="margin-top: 20px;">ion</a-radio>
                            <a-radio value="h" class="radioStyle" style="margin:20px 0px 0px 40px;">ing</a-radio>
                            <a-radio value="i" class="radioStyle" style="margin:20px 0px 0px 40px">ck</a-radio>
                        </div>
                    </a-radio-group>
                </div>
            </a-layout-content>
...
import { HeartTwoTone, HeartOutlined, ExclamationCircleOutlined } from '@ant-design/icons-vue';
...
// 挑战模式的倒计时
const deadline = ref(Date.now() + 1000 * 20); // 设置15秒倒计时
const title = ref('倒计时');
